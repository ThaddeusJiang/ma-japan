defmodule MaWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug MaWeb.EnsureRolePlug, [:user, :admin]

      plug MaWeb.EnsureRolePlug, :admin

      plug MaWeb.EnsureRolePlug, ~w(user admin)a
  """
  ...
  defp maybe_halt(_any, conn) do
    ...
    |> Controller.redirect(to: Routes.product_path(conn, :index))
    |> halt()
  end
end
